...
from routers import portscan, subdomain, whois_lookup, headers, waf, ssl_scan, wpscan, sqli, xss, nuclei_scan, gobuster_scan, hydra_scan, auth, fullscan, history, subdomain_takeover
